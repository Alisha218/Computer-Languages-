...
; ----------------- STRINGS USED THROUGHOUT THE GAME -----------------

PTC DB 'Press any key to continue...$'
...
; ------------ INPUT --------------
   ...
   INECHO
    ...
    TAKEN:
        ...
        PRINT TKN   ; DISPLAY THAT THE CELL IS TAKEN
        ...
        PRINT EMP   ; EMPTY LINE TO OVERWRITE ANOTHER LINE TO CLEAN THE SPACE
